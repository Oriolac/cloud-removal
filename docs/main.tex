...
\end{figure}
	...
	\cite{feller1950} shows that theoratically the infinitesimal step sizes of the true reverse process will have the same functional form as the forward process. Therefore, the each learned reverse step will be also a diagonal gaussian distribution:
